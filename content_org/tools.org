...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :summary "Oh, the magic Org link!"
:END:
:LOGBOOK:
...
efficient.
** TODO python in Emacs and Org mode
:PROPERTIES:
:EXPORT_FILE_NAME: python-in-emacs-and-org-mode
:EXPORT_DATE: <2018-06-02 Sat 21:29>
:EXPORT_DESCRIPTION: summary of this post
:END:
:LOGBOOK:
CLOCK: [2018-06-02 Sat 21:29]--[2018-06-02 Sat 21:30] =>  0:01
:END:

I write this post during reading the book /Learn Python3 the Hard Way/. This is
the first python book I read from page to page.

*** edit the source code in python mode
[2018-05-05 Sat 18:15]
...
*** set the command for evaluating the python code

#+begin_src emacs-lisp
(setq org-babel-python-command "python3")
#+end_src
*** delete the *.elc files
...
After some google, I find the solution at [[https://github.com/syl20bnr/spacemacs/issues/7641][here]] . The solution is easy: deleting
the .elc files under the .emacs.d/elpa/org-plus-contrib-XXXXXX/ directory.
*** export with the result
[2018-05-04 Fri 23:41]
...
*** install the distutils packages
...
Then, I found that there is an extension [[https://github.com/realgud/realgud/][realgud]] , which even allows you use the
...
One more point, it is awesome to preview each article after saving it.
...
** DONE Extends Emacs Org Mode on iOS Device   :@Emacs:Org:
CLOSED: [2018-03-04 Sun 09:31]
:PROPERTIES:
:EXPORT_FILE_NAME: using-emacs-org-mode-on-ios-device
:EXPORT_DATE: <2018-02-25 Sun 11:12>
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :summary "Extends the swiss army knife from PC to movile device."
:END:
:LOGBOOK:
- CLOSING NOTE [2018-03-04 Sun 09:31] \\
  done draft version
...
*** Dropbox
:LOGBOOK:
CLOCK: [2018-04-29 Sun 21:39]--[2018-04-29 Sun 21:40] =>  0:01
:END:
[2018-02-25 Sun 11:17]
...
** DONE Repeated Tasks in Emacs Org     :@Emacs:@tools:Org:
CLOSED: [2018-03-04 Sun 09:32]
:PROPERTIES:
:EXPORT_FILE_NAME: repeated-tasks-in-emacs-org
:EXPORT_DATE: <2018-03-04 Sun 07:16>
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :summary "set deadline or scheculed date for a repeated task in Emacs Org"
:END:
:LOGBOOK:
- CLOSING NOTE [2018-03-04 Sun 09:32] \\
  done with draft version.
  need to update referring to [[https://emacs-china.org/t/org-mode/776][this link]]
CLOCK: [2018-03-04 Sun 08:54]--[2018-03-04 Sun 09:28] =>  0:34
CLOCK: [2018-03-04 Sun 07:16]--[2018-03-04 Sun 07:49] =>  0:33
:END:
...
** DONE write Python in Emacs and Org mode :python:@Emacs:Org:
CLOSED: [2018-05-13 Sun 11:22]
:PROPERTIES:
:EXPORT_FILE_NAME: python-in-org-mode
:EXPORT_DATE: <2018-05-04 Fri 23:34>
:EXPORT_DESCRIPTION: The way I code Python using Emacs and Org mode.
:END:
:LOGBOOK:
- CLOSING NOTE [2018-05-13 Sun 11:22] \\
  done
CLOCK: [2018-05-04 Fri 23:34]--[2018-05-04 Fri 23:36] =>  0:02
:END:
