...
** DONE write and evaluate python in Emacs and maybe Org mode
CLOSED: [2018-05-13 Sun 11:22]
:PROPERTIES:
:EXPORT_FILE_NAME: write-and-evaluate-python-code-in-org-mode
...
#+begin_src python -n :results output :export both
cars = 100
space_in_a_car = 4
drivers = 30
passengers = 90
