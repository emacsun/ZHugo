...
efficient.
** TODO write and evaluate python in Emacs and maybe Org mode
:PROPERTIES:
...
During working on ex23.py, I have an idea to
...
Then, I found that there is an extension [[https://github.com/realgud/realgud/][realgud]] , which even allow you use the
